...
OPTION_USER_AGENT        = ("user-agent",        "user_agent",             fetcherlib.DEFAULT_USER_AGENT,       validMaybeEmpty)
OPTION_CLIENT_AGENT      = ("client-agent",      "client_agent",           fetcherlib.DEFAULT_CLIENT_AGENT,     validMaybeEmpty)
